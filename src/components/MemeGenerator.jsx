        ...
        return (
            <div className='card'>
                ...
                <div className='meme'>
                    ...
                    <Draggable><h2 className='top'>{this.state.topText}</h2></Draggable>
                    <Draggable><h2 className='middle'>{this.state.middleText}</h2></Draggable>
                    <Draggable><h2 className='bottom'>{this.state.bottomText}</h2></Draggable>
